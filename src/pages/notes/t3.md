...
Based on Nimut framework feature test
...
-----------
            ...
            UPDATE sys_domain SET domainName = REPLACE(domainName, 'eesp-cms8.cobweb.local', 'eesp-cms8.cobweb.red');
            UPDATE sys_template SET title = REPLACE(title, 'eesp-cms8.cobweb.local', 'eesp-cms8.cobweb.red');
            UPDATE sys_template SET config = REPLACE(config, 'eesp-cms8.cobweb.local', 'eesp-cms8.cobweb.red');
            UPDATE sys_template SET constants = REPLACE(constants, 'eesp-cms8.cobweb.local', 'eesp-cms8.cobweb.red');
            UPDATE pages SET title = REPLACE(title, 'eesp-cms8.cobweb.local', 'eesp-cms8.cobweb.red');

            UPDATE be_users SET tx_besecurepw_lastpwchange = 3520668683 WHERE username = 'cwtypo3';
...
config.contentObjectExceptionHandler = 0
    ...
    *   Default File Endings for TSconfig files (User+Page) is ".tsconfig"
    ...
    TYPO3\\CMS\\Backend\\Tree\\TreeNode (id = 0)
